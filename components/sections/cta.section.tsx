...
const CTASection = (props: Props) => {
    return (
        <div className={`${styles.ctaSection} px-4 max-w-screen-2xl mx-auto h-full lg:rounded-3xl flex flex-col justify-center lg:py-0 lg:mb-32`}>
            <div className="h-full flex lg:flex-row items-center">
                ...
                <div className="lg:basis-1/4 relative self-end">
                    <Image
                        src={PhoneSideToSIde}
